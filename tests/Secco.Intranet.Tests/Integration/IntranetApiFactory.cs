...
/// </summary>
public sealed class IntranetApiFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
	...
	protected override void ConfigureWebHost(IWebHostBuilder builder)
	{
		...
		builder.ConfigureAppConfiguration((_, configuration) =>
			...
			{
				["Secco:Authentication:Audience"] = "secco-intranet",
