    ...
    public partial class Documentos : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id_pk_documento = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    ds_nome_arquivo = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    ds_content_type = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    nr_tamanho = table.Column<long>(type: "bigint", nullable: false),
                    ie_visibilidade = table.Column<int>(type: "int", nullable: false),
                    ds_caminho_relativo = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    ds_chave_embrulhada = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
