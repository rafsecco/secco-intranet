    ...
    public partial class PerfisColaboradores : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id_pk_perfil_colaborador = table.Column<Guid>(type: "uuid", nullable: false),
                    usuario_id = table.Column<Guid>(type: "uuid", nullable: false),
                    ds_nome_exibicao = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: true),
                    ds_cargo = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: true),
                    ds_ramal = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    ds_sobre = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    id_fk_setor = table.Column<Guid>(type: "uuid", nullable: true),
                    gestor_usuario_id = table.Column<Guid>(type: "uuid", nullable: true),
