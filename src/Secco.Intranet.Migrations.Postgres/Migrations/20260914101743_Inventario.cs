    ...
    public partial class Inventario : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id_pk_item_inventario = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    ds_categoria = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    ds_codigo_patrimonio = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    id_fk_setor = table.Column<Guid>(type: "uuid", nullable: true),
                    ie_status = table.Column<int>(type: "integer", nullable: false),
                    atribuido_a_usuario_id = table.Column<Guid>(type: "uuid", nullable: true),
                    ds_atribuido_a_nome = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
