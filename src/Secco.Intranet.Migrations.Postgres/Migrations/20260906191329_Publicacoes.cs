    ...
    public partial class Publicacoes : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id_pk_publicacao = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    ds_corpo = table.Column<string>(type: "character varying(4000)", maxLength: 4000, nullable: false),
                    ie_tipo = table.Column<int>(type: "integer", nullable: false),
                    ie_visibilidade = table.Column<int>(type: "integer", nullable: false),
                    ie_prioridade = table.Column<int>(type: "integer", nullable: false),
                    dt_publicado_em = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    dt_expira_em = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    ...
                    dt_atualizado_em = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
