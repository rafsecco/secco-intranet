...
/// <param name="Icone">Classe do Bootstrap Icons exibida no menu.</param>
	...
	DateTimeOffset CreatedAt)
{
	...
	public static SetorDto FromEntity(Setor entity) =>
		new(entity.Id, entity.Nome, entity.Slug, entity.Icone, entity.Fixo, entity.Ativo, entity.CreatedAt);
}
